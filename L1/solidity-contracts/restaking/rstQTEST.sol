...
/// @title rstQTEST
/// @notice Restaking receipt token for stQTEST deposits into VybssRestakingVault.
/// @dev Minting/burning is restricted to the restaking vault (manager).
contract rstQTEST {
    string public constant name = "Restaked stQTEST";
    string public constant symbol = "rstQTEST";
